...
bool GameLayer::init(){
	...
	do{
		...
		auto exitItem=MenuItemSprite::create(Sprite::createWithSpriteFrame(cache->spriteFrameByName("exit_norm.png")),
			Sprite::createWithSpriteFrame(cache->spriteFrameByName("exit_press.png")),NULL,[](Object *psender){
		...
		auto restartItem=MenuItemSprite::create(Sprite::createWithSpriteFrame(cache->spriteFrameByName("restart_norm.png")),
			Sprite::createWithSpriteFrame(cache->spriteFrameByName("restart_press.png")),NULL,[=](Object *psender){
		...
		//添加分数显示
		lScore=LabelTTF::create("0","Arial",40);
		...
		auto hScore=LabelTTF::create(String::createWithFormat("%d",high)->getCString(),"Arial",40);
