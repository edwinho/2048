...
void LoadingScene::onEnter(){
	...
	Image *allSpritesImage = new Image();
    allSpritesImage->initWithImageFile("sucai.png");
	 Texture2D *allSpritesTexture = TextureCache::getInstance()->addImage(allSpritesImage, "sucai.png");
     allSpritesImage->release();
	 LoadingScene::loadComplete(allSpritesTexture);
}
